...
// Extracted TicketSelection component
    ...
    {tickets.map((ticket: Ticket) => (
      <div
        ...
        className={`border rounded-lg p-4 cursor-pointer transition-all hover:border-indigo-500
          ${selectedTicket === ticket ? 'border-indigo-500 bg-indigo-50' : 'border-gray-200'}`}
      >
...
// Extracted PriceSummary component
const PriceSummary = ({
  selectedTicket,
  quantity,
}: {
        ...
        <div className="p-6">
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="md:w-1/3">
              ...
              <PriceSummary selectedTicket={selectedTicket} quantity={quantity} />
            </div>
